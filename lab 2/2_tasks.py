...
class Vector:
    ...
    def from_string(cls, s):
        try:
            ...
            print(f"Ошибка: Некорректный ввод '{s}'. Ожидается строка в формате 'x,y,z'.")
            return None
...
if __name__ == "__main__":
    ...
    for _ in range(n):
        point = None
        while point is None:
            point = Vector.from_string(input("Введите координаты точки (x,y,z): "))
        points.append(point)
    ...
    if n >= 2:
        ...
        v2 = None
        while v1 is None:
            v1 = Vector.from_string(input("Введите первый вектор: "))
        while v2 is None:
            v2 = Vector.from_string(input("Введите второй вектор: "))
    ...
    if n >= 3:
        ...
        v3 = None
        while v1 is None:
            v1 = Vector.from_string(input("Введите первый вектор для параллелепипеда: "))
        while v2 is None:
            v2 = Vector.from_string(input("Введите второй вектор для параллелепипеда: "))
        while v3 is None:
            v3 = Vector.from_string(input("Введите третий вектор для параллелепипеда: "))
